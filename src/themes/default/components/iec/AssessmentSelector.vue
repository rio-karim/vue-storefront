<template lang="html">
  <div class="AssessmentSelector">
    <!-- <div class="AssessmentSelector__select">
      <button class="AssessmentSelector__button">
        Erectile Dysfunction
      </button>
      <ul class="AssessmentSelector__list">
        <li class="AssessmentSelector__list-item">Erectile Dysfunction</li>
      </ul>
    </div> -->
    <div @click="selectCondition()" class="AssessmentSelector__select"><div class="select-icon"><span>ED</span></div><span>Erectile Dysfunction</span><span>
    ...
    <router-link
      class="AssessmentSelector__anchor"
      to="/assessment"
      exact>
